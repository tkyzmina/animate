...
var _printText = require("./modules/print-text");
var _handleMenu = require("./modules/handle-menu");
var _handleInput = require("./modules/handle-input");
// ---------------------------------
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  (0, _printText.getText)();
  (0, _handleMenu.handleMenu)();
  (0, _handleInput.handleInput)();
  // Modules
  // ---------------------------------
...
},{"./modules/handle-input":2,"./modules/handle-menu":3,"./modules/print-text":4,"./utils/ios-vh-fix":6,"./utils/scroll-lock":7}],2:[function(require,module,exports){
"use strict";
...
var validate = function validate() {
  ...
  if (input.value.trim().length < 4 || input.value.trim().length > 12) {
    ...
    var valudationResult = useRegex(input.value.trim());
    if (valudationResult) {
      input.classList.add("input-field__input-error");
      isValid = false;
    }
...
var printText = function printText(text) {
  var textParent = document.querySelector(".promo__text");
